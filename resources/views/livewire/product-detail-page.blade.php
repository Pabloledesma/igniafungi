@section('title')
  {{ $product->name . ' Fresco y Deshidratado en Bogotá | Ignia Fungi' }}
@endsection

@section('meta_description')
  {{ Str::limit(strip_tags($product->description), 150) . ' Compra ' . $product->name . ' orgánico en Bogotá. Calidad Gourmet.' }}
@endsection
